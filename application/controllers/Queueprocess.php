...
$this->settings_model->set_setting('queue_is_working', '0');
		...
		$this->twig->display('debug.twig', $this->debug);
	}
...
$this->debug['cmd'] = "get_first_item";
		if ($queue_item === NULL) {
			$this->settings_model->set_setting('queue_is_working', '0');
			exit;
//$this->index();
		}
$this->debug['cmd'] = "get_setting";
...
$this->debug['submission'] = $submission;
//$this->index(); return;
			...
			$userdir = "$problemdir/user/$username";
...
//$this->index(); return;
			//file_put_contents($userdir.'/log', $output);
			...
			$this->queue_model->remove_item($username, $problem['id'], $submit_id);

			// Get next item from queue
			$queue_item = $this->queue_model->get_first_item();
$this->debug['queue_item'] = $queue_item;
//$this->index(); return;
